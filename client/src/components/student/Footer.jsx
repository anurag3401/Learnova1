  ...
  return (
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      ...
      border-white/30'>
        ...
        w-full'>
          <img src={assets.logo_dark1 } alt="" />
          <p className='mt-6 text-center md:text-left text-sm text-white/80'>Your journey to knowledge starts here</p>
        </div>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025 © Radiance Solution. All Right Reserved.</p>
