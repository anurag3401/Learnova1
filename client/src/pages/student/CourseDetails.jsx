...
const CourseDetails = () => {
  ...
  return courseData ? (
    ...
    items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      -z-1 bg-gradient-to-b from-cyan-100/70'></div>
     ...
     {/* Review and Ratings */}
      <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                ...
                <div className='flex'>
                  {[...Array(5)].map((_, i)=>(<img key={i} src={i<Math.floor(calculateRating(courseData)) ?
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Sithkar</span></p>
      ...
      rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        <div className='p-5'>
            ...
            <div className='flex items-center gap-2'>
               ...
               <p className='text-red-500'><span className='font-medium'>5 days</span> 
