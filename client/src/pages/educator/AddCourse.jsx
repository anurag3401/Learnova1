  ...
  return (
    ...
    justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
       ...
       <div className='flex items-center justify-between flex-wrap'>
        <div className='flex flex-col gap-1'>
          ...
          <input onChange={e => setCoursePrice(e.target.value)} value={coursePrice}
           ...
           py-2 w-28 px-3 rounded border border-gray-500' required />
        </div>
      ...
      <div>
                ...
                {chapter.chapterContent.map((lecture, lectureIndex)=>(
                  ...
                  items-center mb-2'>
                    <span>
                      ...
                      min - <a href={lecture.lectureUrl} target='_blank' className='
                      text-blue-500'>Link</a> - 
        ...
        p-2 rounded-lg cursor-pointer' onClick={() => handleChapter('add')}>
          + Add Chapter</div>
                  ...
                  <div className='mb-2'>
                    ...
                    <input
                     ...
                     />
                      ...
                      <button type='button' className='w-full bg-blue-400 text-white
                      px-4 py-2 rounded' onClick={addLecture}>Add</button>
          ...
          <button type='submit' className='bg-black text-white w-max
          py-2.5 px-8 rounded my-4'>
            ADD
          </button>
      </form>
    </div>
